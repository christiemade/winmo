...
if (!class_exists('avia_sc_icon_box', false)) {
	class avia_sc_icon_box extends aviaShortcodeTemplate
	{
		...
		protected function register_dynamic_templates()
		{
			...
			$c = array(
				...
				array(
					...
					'subtype'	=> array(
						__('Apply link to the title', 'avia_framework')		=> '',
		...
		public function shortcode_handler($atts, $content = '', $shortcodename = '', $meta = '')
		{
			...
			$icon_html = '<' . $display_char_wrapper['start'] . ' class="iconbox_icon heading-color fa ' . $atts['custom_font'] . '" ' . $display_char . '></' . $display_char_wrapper['end'] . '>';
